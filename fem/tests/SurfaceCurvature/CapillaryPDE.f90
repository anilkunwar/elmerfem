...
!> This solver is developed from ModelPDE solver and solves void surface 
!> evolution under electromigration force
!> It is to be coupled with some Moving Mesh Solvers
!> Anil Kunwar(2015)
!------------------------------------------------------------------------------
SUBROUTINE CapillarySolver( Model,Solver,dt,TransientSimulation )
!------------------------------------------------------------------------------
  USE DefUtils
...
!------------------------------------------------------------------------------
END SUBROUTINE CapillarySolver
!------------------------------------------------------------------------------
